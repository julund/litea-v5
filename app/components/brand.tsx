const Brand = ({ hidetitle = false }: { hidetitle?: boolean }) => {
    return (
        <>
            {!hidetitle && <span className="text-xl font-black uppercase font-title text-primary-900">Litea</span>}
            <svg className="w-auto h-6" width="100%" height="100%" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0)">
                    ...
                    <path d="M86.36 11.445L65.295 66l52.231-23.302c-5.627-13.713-16.492-25.214-31.166-31.253z" className="text-primary-200" fill="currentColor" />
                </g>
                <defs>
                    <clipPath id="clip0">
