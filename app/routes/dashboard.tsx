...
import { IconChevronLeft, IconChevronRight, IconLogout, IconUser } from "~/components/icons";
...
export default function Dashboard() {
  ...
  const classes = classNames("absolute top-0 z-30 flex flex-col w-screen h-screen max-h-screen gap-2 px-6 py-4 md:sticky bg-base-100 shrink", collapsed ? 
  "md:w-20" :
  "md:w-72")
  ...
  return (
    <DashboardLayout>
      <nav className={classes}>
        <div className="flex">
          <span className="grow"><Logo to="/" /></span>
